...
export function InfoSwitch({ items, defaultSelected = 0 }: { items: InfoItem[]; defaultSelected?: number }) {
      ...
      >
        ...
        {user ? (
          <Avatar
            ...
            className={cn(["lg:w-[12vw]", "lg:h-[12vw]", "w-[20vw]", "h-[20vw]"])}
            fallback={"CN"}
          />
        ) : (
          <CircleUser
            strokeWidth={1}
            className={cn(["lg:w-[12vw]", "lg:h-[12vw]", "w-[20vw]", "h-[20vw]", "text-gray-300"])}
          />
        )}
        <DropdownMenu>
          <DropdownMenuTrigger className={cn(["h-auto"])} asChild>
            ...
            >
              ...
              <p className={cn(["lg:text-2xl", "inline-block", "leading-tight", "font-sans", "font-bold", "w-fit"])}>

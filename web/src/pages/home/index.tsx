            ...
            >
              <CardHeader className={cn(["flex", "flex-col", "items-start"])}>
                <div className={cn(["flex"])}>
                  ...
                  />
                  <div className={cn(["text-2xl", "ml-2"])}>👋</div>
                </div>
                <SplitText
              ...
              <CardContent className={cn(["flex", "gap-3", "flex-col"])}>
                <p className={cn(["text-white/90", "text-center"])}>你现在还没有任何列表</p>
                <Button variant={"ghost"} className={cn(["bg-white/50"])}>
                  <p className={cn(["text-center", "text-base", "text-black/90"])}>开始新建列表,完成任务吧😊</p>
                </Button>
              </CardContent>
            </Card>
          </div>

    ...
    <div className={cn("flex", "flex-col", "lg:flex-row", "gap-5", "2xl:mx-60", "lg:mx-40", "mx-10", "mt-16")}>
      ...
      >
        <div
          className={cn(
            "flex",
            "flex-row", // 小屏幕横向排列（头像 + 用户名）
            "lg:flex-col", // 大屏幕改为垂直排列
            "mb-3",
            "lg:mb-0", // 小屏幕底部间距，大屏去除
            "mx-3",
            "lg:mx-0", // 小屏左右内边距 3，大屏去除
        ...
        >
          ...
          <div className={cn("flex", "flex-col", "items-center", "justify-center", "pl-5", "lg:pl-0", "lg:gap-2")}>
      ...
      <Card className={cn("m-3", "flex-1", "p-6", "md:basis-2/3")}>
        ...
        <CardContent>
          <div className="mb-3">
            <Label htmlFor="name" className={cn("text-[20px]")}>
              {username}
            </Label>
          </div>
          ...
          <Form {...form}>
            ...
            >
              ...
              <div className={cn("flex", "flex-col")}>
                <Label htmlFor="descrip" className="text-[20px]">
                  简介
                </Label>
                <hr className={cn("my-1", "border-gray-300")} />
                <Textarea
